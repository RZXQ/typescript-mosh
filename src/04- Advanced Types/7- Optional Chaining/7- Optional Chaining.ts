...
//
// // Ensures access only when `customer` is neither null nor undefined; ?. only checks for null or undefined
...
//
// // Safely accesses array elements to prevent runtime errors; ?. only checks for null or undefined
